...
from models import FastResRecNet, seq_conv_bn, conv_bn_elu    
...
def run(config, plx_experiment):
    ...
    model = FastResRecNet(conv_kwargs=conv_kwargs, bn_kwargs=bn_kwargs, final_weight=config['final_weight'])
    ...
    optimizer = optimizer_cls(
        [
            ...
            dict([("params", model.layer1[-1].conv_rec.parameters())] + opt_kwargs),
            # conv + bn
            dict([("params", model.layer2[0].parameters())] + opt_kwargs),
            # identity residual recurrent blocks
            dict([("params", model.layer2[-1].conv_rec.parameters())] + opt_kwargs),
            # conv + bn
            dict([("params", model.layer3[0].parameters())] + opt_kwargs),
            # identity residual recurrent blocks
            dict([("params", model.layer3[-1].conv_rec.parameters())] + opt_kwargs),
            # linear
...
if __name__ == "__main__":
    ...
    config = {
        ...
        "lr_param_group_0": [(0, 0.0), (6, 0.25), (num_epochs, 0)],
        "lr_param_group_1": [(0, 0.0), (6, 0.25), (num_epochs, 0)],
        "lr_param_group_2": [(0, 0.0), (6, 0.25), (num_epochs, 0)],
        "lr_param_group_3": [(0, 0.0), (6, 0.25), (num_epochs, 0)],
        "lr_param_group_4": [(0, 0.0), (6, 0.25), (num_epochs, 0)],
        "lr_param_group_5": [(0, 0.0), (6, 0.25), (num_epochs, 0)],
        "lr_param_group_6": [(0, 0.0), (6, 0.25), (num_epochs, 0)],
        "lr_param_group_7": [(0, 0.0), (6, 0.25), (num_epochs, 0)],
        "lr_param_group_8": [(0, 0.0), (6, 0.25), (num_epochs, 0)],
    }
